      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="text-right">
            <a class="btn btn-primary btn-sm" title="Create" href="{{route('teknisi.create')}}">
              Create
            </a>  
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center">
                  <a href="{{ route('teknisi.edit', $data->id) }}" class="btn btn-primary btn-sm">
                    <i class="fa fa-edit"></i>
                  </a>
                  <form action="{{ route('teknisi.destroy', $data->id) }}" method="post" class="d-inline">
                    @csrf
                    @method('delete')
